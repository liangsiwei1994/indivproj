...
# Taken from: https://github.com/aiforsec/LADDER/blob/main/attack_pattern/inference.py
...
# Adapted from: https://github.com/aiforsec/LADDER/blob/main/attack_pattern/inference.py
# Added function to return null
...
# Adapted from: https://github.com/aiforsec/LADDER/blob/main/attack_pattern/inference.py
# Performs additional overall check
...
# Adapted from: https://github.com/aiforsec/LADDER/blob/main/attack_pattern/inference.py
# Added the capability of collecting sentences and phrases at the same time
def infer():
    nltk.download('punkt')
        ...
        for x in sents:
             ...
             if classify_sent(x, sentence_model, tokenizer_sen, token_style_sen, sequence_len_sen, device):
                 ...
                 if not words:
                     ...
                     result += ex + '\n'
        with open(os.path.join(args.save_path, fname[0]+'_predict.txt'), 'w', encoding='utf-8') as f:
            f.write(result)
